        ...
        public void Refresh()
        {
            switch (state)
            {
                case DailyRewardState.UNCLAIMED_AVAILABLE:
                    //print("imageRewardBackground:  " + imageRewardBackground.name);
                    //imageRewardBackground.color = colorClaim;

                    imageRewardBackground.transform.GetChild(1).gameObject.SetActive(true);
                    break;
                case DailyRewardState.UNCLAIMED_UNAVAILABLE:
                    //print("imageRewardBackground:  " + imageRewardBackground.name);
                    //imageRewardBackground.color = colorUnclaimed;

                    imageRewardBackground.transform.GetChild(0).gameObject.SetActive(true);
                ...
                case DailyRewardState.CLAIMED:
                    ...
                    imageRewardBackground.color = colorClaim;
                    imageRewardBackground.transform.GetChild(2).gameObject.SetActive(true);
