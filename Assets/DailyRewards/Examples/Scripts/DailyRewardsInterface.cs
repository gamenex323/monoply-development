...
namespace NiobiumStudios
{
    ...
    public class DailyRewardsInterface : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            {
                //InstanceManager.instance.gameflowmanager.MakeGameFlow();
        ...
        private void InitializeDailyRewardsUI()
        {
            ...
            for (int i = 0; i < dailyRewards.rewards.Count; i++)
            {
                ...
                // Assuming you have a child object of the content GameObject for each daily reward
                GameObject dailyRewardGo = contentTransform.GetChild(i).gameObject;
        ...
        public void UpdateUI()
        {
            ...
            if (isRewardAvailableNow)
            {
                SnapToReward();
                textTimeDue.text = "";
                dueTime.SetActive(false);
                claimNow.SetActive(true);
            }
        ...
        public void SnapToReward()
        {
            ...
            print("lastRewardIdx: " + lastRewardIdx);
            if (lastRewardIdx > 0)
            {
